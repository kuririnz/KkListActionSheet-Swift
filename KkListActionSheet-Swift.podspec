...
Pod::Spec.new do |s|
  s.name         = "KkListActionSheet-Swift"
  s.version      = "0.0.1"
  ...
  s.source       = { :git => "https://github.com/kuririnz/KkListActionSheet-Swift.git", :tag => "0.0.1" }
  s.source_files = "KkListActionSheet-Swift/**/*.swift"
  s.resource     = "KkListActionSheet-Swift/resource/*.xib"
